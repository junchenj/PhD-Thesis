...
\section{Background on Internet Applications}
...
While both generations of Internet telephony technologies rely on
...
\subfloat[Spatial diversity]{
   \includegraphics[width=0.45\textwidth] {figures/back-cross-cdn-spatial.pdf}
   \label{fig:back-cross-cdn-spatial}
 }
% \hspace{0.4cm}
\subfloat[Temporal dynamics]{
   \includegraphics[width=0.45\textwidth] {figures/back-cross-cdn-temporal.pdf}
...
The evolution of the Internet has been largely driven by the need
...
The choices regarding these two dimensions--in-network vs. endpoint, 
...
To cope with the changing network conditions, 
...
\noindent\underline{\smash{Case study: Data-driven congestion control:}}
...
In the last section, we have discussed various ways
