...
%\begin{abstract}
%
%The Internet is an eyeball economy dominated by 
%applications such as Internet video and Internet telephony, whose
%revenue streams crucially depend on user-perceived Quality of 
%Experience (QoE).
...
%%engagement. 
%For instance, even one short buffering interruption 
...
%In contrast, this dissertation demonstrates the feasibility and advantage 
%of a new approach inspired by the recent success of data-driven 
%techniques in other fields of computing. 
%The core thesis is  
...
%sigcomm2014,nsdi13,hotnet14,nsdi14,sigcomm2015,nsdi16,sigcomm2016,hotnet15,imc2015,hotnet16,nsdi17,thesis.bib}
\bibliography{thesis-clean.bib}
