...
%QoE optimization with a radically different answer, and demonstrates that the 
%new approach can get the best of both worlds.
...
{\bf Approaches}                                                        & {\bf Where data is collected?}  & {\bf What data?}                                                                                                                 & {\bf Who make decisions?}                                                                    \\ \hline \hline
In-network                                                        & In-network devices & \begin{tabular}[c]{@{}l@{}}Packet-level statistics \\ {\em no visibility to user-perceived QoE}\end{tabular}                   & \begin{tabular}[c]{@{}l@{}}In-network devices \\ {\em not deployable}\end{tabular}         \\ \hline
Endpoint-based                                                    & Single endpoint    & \begin{tabular}[c]{@{}l@{}}Performance of a single flow \\ {\em limited visibility to network conditions}\end{tabular}         & \begin{tabular}[c]{@{}l@{}}Endpoints \\ {\em readily deployable}\end{tabular}              \\ \hline
\rowcolor{LightCyan}
\begin{tabular}[c]{@{}l@{}}Data-Driven \\ Networking\end{tabular} & Many endpoints     & \begin{tabular}[c]{@{}l@{}}In-situ QoE of many endpoints \\ {\em visibility to QoE \& network conditions}\end{tabular} & \begin{tabular}[c]{@{}l@{}}Centralized controller \\ {\em readily deployable}\end{tabular}
\end{tabular}
\caption{Advantages of \ddn over in-network approaches and endpoint-based approaches.}
\label{tab:intro:contrast}
\end{table}
...
\mypara{\ddn is driven by the right signal} 
...
\mypara{\ddn is readily deployable} 
%\vspace{0.2cm}
%\noindent{\bf Why now?}
...
%new, \ddn, unlike its precursors (e.g.,~\cite{spand}), 
